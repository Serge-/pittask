jsPsych.plugins['PGSI'] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    html += ".jspsych-survey-multi-choice-question { display: flex; text-align: left; border-bottom: 1px solid }" +
      ...
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {  width: 100%; border-right: 1px solid #fff; }" +
      ...
      ".jspsych-content { margin-top: 130px; width: 1000px; min-width: 450px; }" +
      ".jspsych-survey-multi-choice-instructions li { font-size: 19px; }" +
      "ul {list-style: none}" +
      ...
      "@media (max-width: 800px) {" +
        ".jspsych-survey-multi-choice-instructions li { font-size: 18px; }" +
      "}"+
      "@media (max-width: 700px) {" +
        ...
        ".jspsych-survey-multi-choice-instructions li { font-size: 16px; }" +
      "}"+
    ...
    html +=
      `<div id="jspsych-survey-multi-choice-preamble" class="jspsych-survey-multi-choice-instructions">
          ...
          <ul>
            ...
            <li><div>Most of the time</div></li>
