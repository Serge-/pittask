    ...
    test('send data', () => {
        ...
        var parameters = {
            ...
            variables: {
                ...
                VVR_q_text_a1: 'Which directions did you get tilt to get',
                VVR_q_text_a2: 'Press Left or Right button',
                VVR_q_text_b1: 'How strongly do you believe in your answer?',
                VVR_q_text_b2: 'Very little',
                VVR_q_text_b3: 'Very much!',
                VVR_q_text_b4: '<li><span>Select answer using your mouse.</span></li><li><span>Click \'submit answer\' when ready</span></li>',
