...
test('check inputs', async () => {
  // if (await page.$("#jspsych-survey-multi-choice-OSC-R")) {
  //   // there was an error
  //   console.log('object');
  // } else {
  //   // the page changed
  ...
  // }
  // await page.waitForSelector('#jspsych-survey-multi-choice-OSC-R', {timeout: 10000}).then(() => {
  //   console.log('OSC-R');
  // })
    ...
    const selector = await raceSelectors(page, ['#jspsych-survey-multi-choice-OSC-R', '#jspsych-survey-multi-choice-DEMOGRAPHICS']);
    
    if (selector === '#jspsych-survey-multi-choice-OSC-R') {
      // do something
      console.log('OSC-R');
    } else if (selector === '#jspsych-survey-multi-choice-DEMOGRAPHICS') {
        // do something else
        console.log('DEM');
    }
})
...
test('check inputs OSC-R', async () => {
  ...
  // })
    ...
    //     console.log('DEM');
    // }
    var aaa = await page.waitForSelector('#jspsych-survey-multi-choice-OSC-R')
    console.log(aaa);
})
